...
const GAS_ESTIMATES = {
    createChannelAndDepositAlice: BigNumber.from(250000),
    createChannel: BigNumber.from(250000),
    depositAlice: BigNumber.from(75000),
    depositBob: BigNumber.from(50000),
    withdraw: BigNumber.from(100000),
};
const ERC20Abi = [
...
const REDUCED_GAS_PRICE = parseUnits("125", "gwei");
...
const GetTransfersParamsSchema$1 = Type.Object({ publicIdentifier: TPublicIdentifier });
...
(function (NodeParams) {
    ...
    NodeParams.GetTransfersSchema = GetTransfersParamsSchema$1;
...
export { ARBITRUM_TESTNET_1_CHAIN_ID, AUTODEPLOY_CHAIN_IDS, AllowedSwapSchema, BalanceEncoding, CONDITIONAL_TRANSFER_CREATED_EVENT, CONDITIONAL_TRANSFER_RESOLVED_EVENT, ChainError, ChannelCommitmentTypes, ChannelRpcMethods, CoreChannelStateEncoding, CoreTransferStateEncoding, DEFAULT_CHANNEL_TIMEOUT, DEFAULT_TRANSFER_TIMEOUT, DEPOSIT_RECONCILED_EVENT, ERC20Abi, EngineError, EngineEvents, EngineParams, GAS_ESTIMATES, GetTransfersFilterOptsSchema, HashlockTransferName, HashlockTransferResolverEncoding, HashlockTransferStateEncoding, IS_ALIVE_EVENT, MAXIMUM_CHANNEL_TIMEOUT, MAXIMUM_TRANSFER_TIMEOUT, MINIMUM_CHANNEL_TIMEOUT, MINIMUM_TRANSFER_TIMEOUT, MessagingError, NodeError, NodeParams, NodeResponses, ProtocolError, ProtocolEventName, ProtocolParams, REDUCED_GAS_PRICE, REQUEST_COLLATERAL_EVENT, RESTORE_STATE_EVENT, Result, RouterError, RouterSchemas, SETUP_EVENT, StoredTransactionStatus, TAddress, TBalance, TBasicMeta, TBytes, TBytes32, TChainId, TChannelUpdate, TChannelUpdateDetails, TChannelUpdateType, TContractAddresses, TCreateUpdateDetails, TDecimalString, TDepositUpdateDetails, TFullChannelState, TFullTransferState, TIntegerString, TNetworkContext, TPublicIdentifier, TRANSFER_DECREMENT, TResolveUpdateDetails, TSetupUpdateDetails, TSignature, TTransferMeta, TUrl, TransactionEvents, TransactionReason, TransferEncodingSchema, TransferEncodingsMap, TransferNameSchema, TransferNames, TransferQuoteEncoding, TransferQuoteSchema, TransferResolverSchema, TransferStateSchema, UINT_MAX, UpdateType, VectorError, VectorNodeConfigSchema, WITHDRAWAL_CREATED_EVENT, WITHDRAWAL_RECONCILED_EVENT, WITHDRAWAL_RESOLVED_EVENT, WithdrawDataEncoding, WithdrawName, WithdrawResolverEncoding, WithdrawStateEncoding, WithdrawalQuoteEncoding, WithdrawalQuoteSchema, enumify, jsonifyError, tidy };
