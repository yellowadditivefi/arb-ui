...
class WithdrawCommitment {
    constructor(channelAddress, alice, bob, recipient, assetId, amount, nonce, callTo = constants_1.AddressZero, callData = "0x", transactionHash) {
    ...
    static async fromJson(json) {
        const commitment = new WithdrawCommitment(json.channelAddress, json.alice, json.bob, json.recipient, json.assetId, json.amount, json.nonce, json.callTo, json.callData, json.transactionHash);
