...
const xdaiChannelFactory = __importStar(require("../deployments/xdai/ChannelFactory.json"));
const xdaiChannelMastercopy = __importStar(require("../deployments/xdai/ChannelMastercopy.json"));
const xdaiHashlockTransfer = __importStar(require("../deployments/xdai/HashlockTransfer.json"));
const xdaiTestToken = __importStar(require("../deployments/xdai/TestToken.json"));
const xdaiTransferRegistry = __importStar(require("../deployments/xdai/TransferRegistry.json"));
const xdaiWithdraw = __importStar(require("../deployments/xdai/Withdraw.json"));
...
exports.deployments.xdai = xdaiDeployment;
exports.deployments["100"] = xdaiDeployment;
const bsctestnetChannelFactory = __importStar(require("../deployments/bsctestnet/ChannelFactory.json"));
const bsctestnetChannelMastercopy = __importStar(require("../deployments/bsctestnet/ChannelMastercopy.json"));
const bsctestnetHashlockTransfer = __importStar(require("../deployments/bsctestnet/HashlockTransfer.json"));
const bsctestnetTestToken = __importStar(require("../deployments/bsctestnet/TestToken.json"));
const bsctestnetTransferRegistry = __importStar(require("../deployments/bsctestnet/TransferRegistry.json"));
const bsctestnetWithdraw = __importStar(require("../deployments/bsctestnet/Withdraw.json"));
...
exports.deployments.bsctestnet = bsctestnetDeployment;
exports.deployments["97"] = bsctestnetDeployment;
const bscChannelFactory = __importStar(require("../deployments/bsc/ChannelFactory.json"));
const bscChannelMastercopy = __importStar(require("../deployments/bsc/ChannelMastercopy.json"));
const bscHashlockTransfer = __importStar(require("../deployments/bsc/HashlockTransfer.json"));
const bscTestToken = __importStar(require("../deployments/bsc/TestToken.json"));
const bscTransferRegistry = __importStar(require("../deployments/bsc/TransferRegistry.json"));
const bscWithdraw = __importStar(require("../deployments/bsc/Withdraw.json"));
const bscDeployment = {
...
exports.deployments.bsc = bscDeployment;
exports.deployments["56"] = bscDeployment;
